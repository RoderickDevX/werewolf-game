...
def test_werewolf_subdomain_serves_game():
    ...
    assert "styles.css?v=20260702-player-meta-pills" in response.text
    assert "app.js?v=20260702-final-result-step-player-meta-pills-vote-select-lock" in response.text
